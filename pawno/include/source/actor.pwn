...
stock LoadBot()
{
	BotPears[0] = CreateActor(8, 944.2403,-1709.4430,13.5823,181.0545);// ���������� LV 1 ����
	BotPears[1] = CreateActor(27, 2271.6897,2785.0352,10.8203,26.2866);// ��������������� ����� �����
	BotPears[2] = CreateActor(133, 1617.7690,-1895.4532,13.8599,266.8432); // ��������� ����������� ������ LS
	BotPears[3] = CreateActor(133, -1872.4868,-218.2040,18.6155,272.1465); // ��������� ����������� ������ SF
	BotPears[4] = CreateActor(133, 1034.6359,2215.3616,11.0254,359.8574); // ��������� ����������� ������ LV
	BotPears[5] = CreateActor(133, 992.0648,-1342.0739,13.6369,183.5969); // ���������� ���� LS
	BotPears[6] = CreateActor(151, 1477.2902,-1782.6528,15.3182,0.3031); // ��������������� �����
	SetActorVirtualWorld(BotPears[6], 197);
	BotPears[7] = CreateActor(147, 1509.1925,-1782.7321,21.0902,1.0359); // ��������������� ����� 2 ���� ������
	SetActorVirtualWorld(BotPears[7], 196);
	BotPears[8] = CreateActor(10, 1474.8569,-1806.1353,21.0982,359.8061); // ��������������� ����� 2 ���� ������������
	SetActorVirtualWorld(BotPears[8], 196);
	BotPears[9] = CreateActor(158, -22.0634,81.3438,3.1096,68.7555); // ����� ��� �� �����
	BotPears[10] = CreateActor(162, -43.4430,51.2411,3.1179,252.8287); // ����� ��� �� ����� (������)
	BotPears[11] = CreateActor(141, 2166.4031,2371.6714,23.6143,226.8451); // FBI Bot 1
	SetActorVirtualWorld(BotPears[11], 243);
	BotPears[12] = CreateActor(42, 1512.3502,-2183.3281,13.7929,249.3819); // �������� Bot
	BotPears[13] = CreateActor(50, 1503.8464,-2183.2341,13.7929,100.0888); // �������� Bot
	BotPears[14] = CreateActor(151, 1509.9032,-2174.9246,13.6277,270.0855); // �������� Bot
	BotPears[15] = CreateActor(42, 893.1202,1903.3278,11.0516,337.5979); // �������� Bot
	BotPears[16] = CreateActor(50, 892.9305,1894.7195,11.0516,191.5832); // �������� Bot
	BotPears[17] = CreateActor(151, 884.5753,1900.7799,10.8864,359.6999); // �������� Bot
	BotPears[18] = CreateActor(42, -2630.7766,1359.5754,7.2240,332.5845); // �������� Bot
	BotPears[19] = CreateActor(50, -2630.6655,1351.4535,7.2240,216.6501); // �������� Bot
	BotPears[20] = CreateActor(151, -2639.1790,1357.3517,7.1398,359.6998); // �������� Bot
	BotPears[21] = CreateActor(42, -1562.2402,-2741.6199,48.7603,213.2033); // �������� Bot
	...
	BotPears[30] = CreateActor(6, 1380.1854,-5.4021,1000.9713,257.5052); // �������� ����� Bot 1 [ ������� ]
	SetActorVirtualWorld(BotPears[30], 219);
	BotPears[31] = CreateActor(95, 995.3415,-1954.1554,12.8842,182.6652); // �������� ����� Bot 2 [ ������� ���� ]
	BotPears[32] = CreateActor(150, 1276.9844,-46.5174,1000.9280,358.1093); // �������� Bot 1 [ ����� ]
	SetActorVirtualWorld(BotPears[32], 3);
	BotPears[33] = CreateActor(170, 1589.9722,-2279.1296,13.5331,244.2788); // �������� Bot 2
	BotPears[34] = CreateActor(96, 1613.8485,-2278.8977,13.5732,347.3431); // �������� Bot 3
	BotPears[35] = CreateActor(97, 1614.2062,-2277.4736,13.5656,162.1847); // �������� Bot 4
    BotPears[36] = CreateActor(3, 1625.8187,-2295.5776,13.5372,128.6577); // �������� Bot 5 [ ����� ]
	BotPears[37] = CreateActor(199, 1733.8733,-1901.9637,916.0651,281.3157); // ������ Bot 6
	SetActorVirtualWorld(BotPears[37], 7);
	BotPears[38] = CreateActor(188, 1743.0204,-1899.2825,916.0651,289.1492); // ������ Bot 7
	SetActorVirtualWorld(BotPears[38], 7);
	BotPears[39] = CreateActor(185, 1744.4777,-1898.8420,916.0651,101.7975); // ������ Bot 8
	SetActorVirtualWorld(BotPears[39], 7);
	BotPears[40] = CreateActor(71, 1743.6726,-1895.4208,913.6010,357.6015); // ������ Bot 9
	SetActorVirtualWorld(BotPears[40], 7);
	BotPears[45] = CreateActor(151, 607.0654,-1538.5491,15.3926,268.8089); // ���������� Bot 1 [ ���������� ������� ]
	SetActorVirtualWorld(BotPears[45], 220);
	BotPears[46] = CreateActor(159, -29.5093,67.5059,3.1172,72.0570); // ����� ��� �� ����� (������)
    BotPears[47] = CreateActor(262,-338.6107,1729.5956,42.8917,4.2150); // ���������� ��� �� ����� (����������� �������)
    BotPears[48] = CreateActor(133, -1655.5134,1289.8231,7.2908,225.2348); // ���������� ���� SF
	BotPears[49] = CreateActor(308, 1391.5339,-13.7709,1000.9217,1.1784); // ��������� Bot 2
	...
	BotPears[51] = CreateActor(308, 1163.3939,-1315.3433,898.0944,90.6377); // ��������� Bot 4
	SetActorVirtualWorld(BotPears[51], 1);
	BotPears[52] = CreateActor(250, 1161.7295,-1315.5109,898.0944,274.2293); // ��������� Bot 5
	SetActorVirtualWorld(BotPears[52], 1);
	BotPears[53] = CreateActor(259, 1150.3359,-1297.2848,898.7470,180.6266); // ��������� Bot 6
	SetActorVirtualWorld(BotPears[53], 1);
	BotPears[54] = CreateActor(229, 1153.5736,-1302.8451,898.7470,275.0858); // ��������� Bot 7
    ...
    BotPears[56] = CreateActor(50, -1569.2174,-2737.0059,48.7603,78.7820); // �������� Bot
	BotPears[57] = CreateActor(151, -1559.4789,-2733.2468,48.5951,236.8721); // �������� Bot
	...
	BotPears[69] = CreateActor(42, 60.9589,-190.2918,1.8558,248.9236); // �������� Bot
	BotPears[70] = CreateActor(50, 52.7649,-189.7369,1.8558,108.5488); // �������� Bot
	BotPears[71] = CreateActor(151, 58.9251,-181.5847,1.6906,265.0719); // �������� Bot
    ...
    BotPears[75] = CreateActor(133, 1063.9913,2306.4170,11.0953,270.3401); // ���������� ���� LV
	...
	BotPears[100] = CreateActor(68, 1327.8085,1585.8474,11.0259,271.6756); // ������� Bot 1 [ ��������� ]
	...
	BotPears[103] = CreateActor(161, -1631.7679,-2234.6997,31.4766,160.4179); // ������ Bot 1
	BotPears[104] = CreateActor(11, 1793.9835,-1772.1897,13.7935,90.5202); // ��������� Bot 1
	...
	BotPears[110] = CreateActor(276, 1154.4517,-1302.5990,898.1036,106.8008); // ��������� Bot 8
	SetActorVirtualWorld(BotPears[110], 1);
	BotPears[111] = CreateActor(15, 1171.6820,-1297.7162,898.7470,92.0739); // ��������� Bot 8
	SetActorVirtualWorld(BotPears[111], 1);
	BotPears[112] = CreateActor(32, 1168.5963,-1303.1786,898.7470,2.3148); // ��������� Bot 10
	SetActorVirtualWorld(BotPears[112], 1);
	BotPears[113] = CreateActor(34, 1150.8004,-1305.3921,898.7470,92.7241); // ��������� Bot 11
	SetActorVirtualWorld(BotPears[113], 1);
	BotPears[114] = CreateActor(44, 1147.5684,-1311.3845,898.7470,0.7715); // ��������� Bot 12
	SetActorVirtualWorld(BotPears[114], 1);
	BotPears[115] = CreateActor(54, 1168.3097,-1310.6511,898.7470,275.4225); // ��������� Bot 13
	SetActorVirtualWorld(BotPears[115], 1);
	BotPears[116] = CreateActor(58, 1150.9082,-1328.6205,898.0944,186.1451); // ��������� Bot 14
	SetActorVirtualWorld(BotPears[116], 1);
	BotPears[117] = CreateActor(275, 1150.9603,-1329.8462,898.0944,9.4234); // ��������� Bot 15
	SetActorVirtualWorld(BotPears[117], 1);
	BotPears[118] = CreateActor(71, 1162.4762,-1328.9657,898.0944,4.3867); // ��������� Bot 16
	SetActorVirtualWorld(BotPears[118], 1);
	BotPears[119] = CreateActor(275, 1138.6152,-1349.8079,898.0916,181.7350); // ��������� Bot 17
	SetActorVirtualWorld(BotPears[119], 1);
	BotPears[120] = CreateActor(276, 1138.5537,-1351.0946,898.0916,357.1800); // ��������� Bot 18
	SetActorVirtualWorld(BotPears[120], 1);
	BotPears[121] = CreateActor(252, 1156.0387,-1382.1033,898.8210,96.7777); // ��������� Bot 19
	SetActorVirtualWorld(BotPears[121], 1);
	BotPears[122] = CreateActor(70, 1118.0420,-1362.3555,898.0916,274.5060); // ��������� Bot 20
	...
	BotPears[204] = CreateActor(36, -337.9493,1725.6622,42.8531,270.0621); // ���������� Bot 1
	BotPears[207] = CreateActor(42, 1934.9749,-1779.5398,13.7258,327.5147);// ��������� Bot 1
	BotPears[208] = CreateActor(50, 1934.4780,-1787.4510,13.7258,192.4313);// ��������� Bot 2
	BotPears[209] = CreateActor(151, 1926.0579,-1781.8629,13.5606,358.2216);// ��������� Bot 3
	BotPears[219] = CreateActor(42, -1675.1141,421.4946,7.3641,297.0783);// ��������� Bot 4
	BotPears[220] = CreateActor(50, -1680.8055,415.6465,7.3641,158.2703);// ��������� Bot 5
	BotPears[221] = CreateActor(151, -1682.5594,425.5037,7.1989,316.5287);// ��������� Bot 6
	BotPears[222] = CreateActor(11, 1638.1517,1449.1168,15.3081,270.8537);// ��������� Bot 1
	BotPears[226] = CreateActor(37, -2230.7534,251.7373,894.7211,4.7700); // ������� ������ Bot 1
	SetActorVirtualWorld(BotPears[226], 77);
	BotPears[227] = CreateActor(42, -2105.4768,-0.9047,35.5099,339.2878);// ��������� Bot 7 sf-2
	BotPears[228] = CreateActor(50, -2105.5925,-8.6365,35.5099,199.8531);// ��������� Bot 8 sf-2
	BotPears[229] = CreateActor(151, -2113.7688,-3.1075,35.3447,358.4013);// ��������� Bot 9 sf-2
	BotPears[230] = CreateActor(42, 157.5066,-1614.4482,14.7704,14.7461);// ��������� Bot 10 ls-2
	BotPears[231] = CreateActor(50, 162.5071,-1620.5380,14.7704,239.3851);// ��������� Bot 11 ls-2
	BotPears[232] = CreateActor(151, 152.5646,-1621.7789,14.6052,42.7584);// ��������� Bot 12 ls-2
	BotPears[233] = CreateActor(42, 1844.1437,817.5923,10.9726,56.9960);// ��������� Bot 13 lv-1
	BotPears[234] = CreateActor(50, 1852.0760,817.3677,10.9730,289.3431);// ��������� Bot 14 lv-1
	BotPears[235] = CreateActor(151, 1846.3289,809.4238,10.8216,90.0844);// ��������� Bot 15 lv-1
	BotPears[236] = CreateActor(42, 2250.1785,2391.5908,11.0000,56.4122);// ��������� Bot 16 lv-2
	BotPears[237] = CreateActor(50, 2258.2874,2391.3408,11.0000,284.2471);// ��������� Bot 17 lv-2
	BotPears[238] = CreateActor(151, 2252.6345,2383.2349,10.8348,90.0646);// ��������� Bot 18 lv-2
	BotPears[240] = CreateActor(155, 1717.9539,-2410.4026,13.5767,180.5654); // �������� Bot 1
	SetActorVirtualWorld(BotPears[240], 198);
	BotPears[241] = CreateActor(71, 1728.6202,-2411.7305,13.5767,271.0727); // �������� Bot 1
	SetActorVirtualWorld(BotPears[241], 198);
	BotPears[242] = CreateActor(71, 1738.4613,-2433.9980,13.5767,89.8428); // �������� Bot 1
	SetActorVirtualWorld(BotPears[242], 198);
	BotPears[243] = CreateActor(150, 1742.0760,-2421.0786,13.5767,91.7972); // �������� Bot 1
	SetActorVirtualWorld(BotPears[243], 198);
	BotPears[244] = CreateActor(150, 1742.0778,-2425.4563,13.5767,91.7972); // �������� Bot 1
	SetActorVirtualWorld(BotPears[244], 198);
	BotPears[245] = CreateActor(150, 1742.0760,-2429.7825,13.5767,89.8938); // �������� Bot 1
	SetActorVirtualWorld(BotPears[245], 198);
	BotPears[250] = CreateActor(158, -35.4461,77.0759,3.1331,13.4866); // ����� Bot 1
    ...
    BotPears[275] = CreateActor(301,1461.7512,-92.3984,26.7904,316.2536); // ������ Bot
    BotPears[276] = CreateActor(302,1473.8959,-88.8228,26.7904,151.1254); // ������ Bot
    BotPears[277] = CreateActor(288,1473.4253,-89.7908,26.7904,330.2359); // ������ Bot
    BotPears[278] = CreateActor(301,1517.2401,-29.4957,26.7835,131.0954); // ������ Bot
    BotPears[279] = CreateActor(281,-1954.7623,2344.0791,1549.6833,179.2847); // ������ Bot
    SetActorVirtualWorld(BotPears[279], 36);
    BotPears[280] = CreateActor(283,-1952.8025,2370.2859,1549.6833,177.7180); // ������ Bot
    SetActorVirtualWorld(BotPears[280], 36);
    BotPears[281] = CreateActor(268,-1940.0203,2382.6238,1549.6833,270.7734); // ������ Bot
    SetActorVirtualWorld(BotPears[281], 37);
    BotPears[282] = CreateActor(268,-1945.2432,2389.0210,1549.6833,0.7008); // ������ Bot
    SetActorVirtualWorld(BotPears[282], 37);
    BotPears[283] = CreateActor(288,615.3415,-540.1636,1492.0072,3.2988); // ������ Bot
    SetActorVirtualWorld(BotPears[283], 36);
    BotPears[284] = CreateActor(28,1431.5796,-132.3715,26.7904,37.8463); // ������ Bot
    BotPears[285] = CreateActor(30,1410.6948,-119.8417,26.7904,277.6937); // ������ Bot
    BotPears[286] = CreateActor(42,1427.3776,-115.7589,26.7904,20.0096); // ������ Bot
    BotPears[287] = CreateActor(268,1426.8988,-114.0483,26.7904,194.5379); // ������ Bot
    BotPears[288] = CreateActor(48,1421.5983,-145.5395,27.8694,36.9531); // ������ Bot
    BotPears[289] = CreateActor(67,1424.7656,-144.2773,28.1855,36.9531); // ������ Bot
    BotPears[290] = CreateActor(28,1405.3990,-125.5751,26.7904,358.7261); // ������ Bot
    BotPears[291] = CreateActor(25,1406.2046,-123.9625,26.7904,125.0006); // ������ Bot
    BotPears[292] = CreateActor(21,1404.6963,-123.8337,26.7904,210.8548); // ������ Bot
    BotPears[293] = CreateActor(281,-1943.1350,2379.3757,1549.6833,176.0008); // ������ Bot otb 37 ��� �������� ����
    SetActorVirtualWorld(BotPears[293], 37);
    BotPears[294] = CreateActor(283,-1933.6089,2379.3655,1549.6833,0.2191); // ������ Bot otb 37 ��� �������� ����
    SetActorVirtualWorld(BotPears[294], 37);
    BotPears[295] = CreateActor(280,-1948.9519,2381.6292,1549.6833,186.0274); // ������ Bot ����������� ����� ���� 36 ���
    SetActorVirtualWorld(BotPears[295], 36);
    BotPears[296] = CreateActor(288,605.9303,-549.1145,1492.0072,270.5513); // ������ Bot ����������� ����� ���� 36 ���
    SetActorVirtualWorld(BotPears[296], 36);
    BotPears[297] = CreateActor(300,636.8461,-544.0811,1492.0072,333.7004); // ������ Bot ���� 1 ������ � 2 36 ���
    SetActorVirtualWorld(BotPears[297], 36);
    BotPears[298] = CreateActor(301,637.6428,-542.6046,1492.0072,146.0353); // ������ Bot ���� 2 ������ � 1 36 ���
    SetActorVirtualWorld(BotPears[298], 36);
    BotPears[299] = CreateActor(297,609.4335,-529.0662,1496.1713,180.3573); // ������ Bot ��� ����� ����� �� ������ otb 36 ���
    SetActorVirtualWorld(BotPears[299], 36);
    BotPears[300] = CreateActor(261,-1950.0703,2340.0571,1549.6833,150.4520); // ������ Bot ����������� 1 ������ � 2 36 ���
    SetActorVirtualWorld(BotPears[300], 36);
    BotPears[301] = CreateActor(259,-1950.6799,2338.4812,1549.6833,333.1270); // ������ Bot ����������� 2 ������ � 1 36 ���
    SetActorVirtualWorld(BotPears[301], 36);
    BotPears[302] = CreateActor(267,-1948.5565,2350.3408,1549.6833,99.5464); // ������ Bot ���� ����� �� ����� ������ 36 ���
    SetActorVirtualWorld(BotPears[302], 36);
    BotPears[303] = CreateActor(248,1429.9197,-107.2486,26.7904,132.3054); // ������ Bot ��� ����� ������������� �����
    BotPears[304] = CreateActor(247,1420.6920,-129.9727,26.7904,189.1877); // ������ Bot ��� ������  �����
    BotPears[305] = CreateActor(206,1419.7673,-131.7033,26.7904,320.7889); // ������ Bot ��� ������ �����
    BotPears[306] = CreateActor(242,1421.5477,-131.0888,26.7904,65.1299); // ������ Bot ��� otb �����
    BotPears[307] = CreateActor(182,1410.1254,-139.7495,26.7904,227.4147); // ������ Bot ��� ����� �����
    BotPears[308] = CreateActor(183,1411.6548,-140.8968,26.7904,52.2831); // ������ Bot ��� ������� ��� ��� �� �����
    BotPears[309] = CreateActor(297,1415.3198,-125.3952,26.7904,85.1366); // ������ Bot ��� ������ �����
    BotPears[310] = CreateActor(163,1292.8673,-53.0409,1000.9422,183.6430); // ������������� Bot
    SetActorVirtualWorld(BotPears[310], 234);
    BotPears[311] = CreateActor(164,1304.5822,-65.5058,1000.9422,7.8614); // ������������� Bot
    SetActorVirtualWorld(BotPears[311], 234);
    BotPears[312] = CreateActor(150,1283.8494,-61.0814,1002.3203,270.9135); // ������������� Bot
    SetActorVirtualWorld(BotPears[312], 234);
    BotPears[313] = CreateActor(147,-2046.6985,-988.4554,1651.6968,30.9710); // ������������� Bot
    SetActorVirtualWorld(BotPears[313], 7);
    BotPears[314] = CreateActor(187,-2047.6536,-987.2053,1651.6968,215.5261); // ������������� Bot
    SetActorVirtualWorld(BotPears[314], 7);
    BotPears[315] = CreateActor(164,-2000.2031,161.7839,1666.0313,93.0917); // ������������� Bot
    SetActorVirtualWorld(BotPears[315], 7);
    BotPears[322] = CreateActor(6,2380.3674,563.8082,909.7986,95.1605); // ����� ������� Bot
    SetActorVirtualWorld(BotPears[322], 98);
    BotPears[323] = CreateActor(202,1382.5847,-21.8886,1001.0793,94.5528); // ������������� Bot [ ������� ��� ]
    SetActorVirtualWorld(BotPears[323], 11);
    BotPears[324] = CreateActor(206,1377.6793,-15.4435,1001.0717,220.1772); // ������������� Bot
    SetActorVirtualWorld(BotPears[324], 11);
    BotPears[325] = CreateActor(261,1378.6981,-16.7620,1001.0717,38.1523); // ������������� Bot
    SetActorVirtualWorld(BotPears[325], 11);
    BotPears[350] = CreateActor(16,2532.5154,2800.9751,10.8203,125.0607); // ��������������������� ����� Bot
    BotPears[351] = CreateActor(27,2517.1875,2829.1831,10.8203,246.0552); // ��������������������� ����� Bot
    BotPears[352] = CreateActor(153,2518.6653,2828.4517,10.8203,58.7035); // ��������������������� ����� Bot
    ...
    BotPears[376] = CreateActor(194,2211.8379,1029.4117,994.4688,182.3280); // ������ Bot �����
    SetActorVirtualWorld(BotPears[376], 2001);
    BotPears[377] = CreateActor(172,2216.7393,1029.4164,994.4688,180.7613); // ������ Bot �����
    SetActorVirtualWorld(BotPears[377], 2001);
    BotPears[378] = CreateActor(171,2221.4226,1029.4115,994.4688,180.4480); // ������ Bot �����
    SetActorVirtualWorld(BotPears[378], 2001);
    BotPears[379] = CreateActor(172,2183.0564,1013.2817,992.4688,180.3346); // ������ Bot ������� [0]
    SetActorVirtualWorld(BotPears[379], 2001);
    BotPears[380] = CreateActor(172,2183.0564,1019.2822,992.4688,177.8512); // ������ Bot ������� [1]
    SetActorVirtualWorld(BotPears[380], 2001);
    BotPears[381] = CreateActor(172,2183.0564,1025.2816,992.4688,174.0912); // ������ Bot ������� [2]
    SetActorVirtualWorld(BotPears[381], 2001);
    BotPears[382] = CreateActor(171,2171.3940,1014.0906,992.4688,106.5708); // ��� � ���� ������
	SetActorVirtualWorld(BotPears[382], 2001);
	BotPears[383] = CreateActor(171,2171.5842,1022.4432,992.4688,83.6973); // ��� � ���� ������
	SetActorVirtualWorld(BotPears[383], 2001);
	BotPears[384] = CreateActor(163,2201.9219,1007.3365,994.4688,91.9738); // �������� otb ������
	SetActorVirtualWorld(BotPears[384], 2001);
	BotPears[385] = CreateActor(171,2176.9482,1020.9529,992.4688,277.3156); // ��� � ���� ������
	SetActorVirtualWorld(BotPears[385], 2001);
    BotPears[386] = CreateActor(171,2176.8618,1014.8093,992.4688,270.7356); // ��� � ���� ������
	SetActorVirtualWorld(BotPears[386], 2001);
	BotPears[387] = CreateActor(171,2171.0869,1018.0458,992.4688,95.1071); // ��� � ���� ������
	SetActorVirtualWorld(BotPears[387], 2001);
	BotPears[388] = CreateActor(163,2170.4785,998.8090,992.4688,358.4547); // �������� otb ������
	SetActorVirtualWorld(BotPears[388], 2001);
	BotPears[391] = CreateActor(164,2242.9587,1021.4113,996.8750,89.6121); // �������� otb ������
	SetActorVirtualWorld(BotPears[391], 2001);
	BotPears[392] = CreateActor(163,2243.1431,1014.8881,996.8818,90.8655); // �������� otb ������
	...
	BotPears[411] = CreateActor(71, 1402.2173,3.8803,1000.9217,92.9859); // ��������� Bot 21
	SetActorVirtualWorld(BotPears[411], 5);
	BotPears[412] = CreateActor(71, 1376.4246,-6.3177,1000.9267,182.4317); // ��������� Bot 22
	SetActorVirtualWorld(BotPears[412], 5);
	BotPears[413] = CreateActor(71, 1395.8878,-16.0300,1000.9217,271.3257); // ��������� Bot 23
	SetActorVirtualWorld(BotPears[413], 5);
	BotPears[414] = CreateActor(274, 1400.1345,-21.4354,1000.9217,253.0776); // ��������� Bot 24
	SetActorVirtualWorld(BotPears[414], 5);
	BotPears[415] = CreateActor(272, 1401.3024,-21.7337,1000.9217,71.9927); // ��������� Bot 25
	SetActorVirtualWorld(BotPears[415], 5);
	BotPears[416] = CreateActor(70, 1377.5765,-21.8737,1000.9217,51.2186); // ��������� Bot 26
	SetActorVirtualWorld(BotPears[416], 6);
	BotPears[417] = CreateActor(276, 1386.7156,-13.8015,1000.9217,9.9520); // ��������� Bot 27
	SetActorVirtualWorld(BotPears[417], 5);
	BotPears[418] = CreateActor(259, 1386.1909,-12.0045,1000.9219,195.7369); // ��������� Bot 28
	SetActorVirtualWorld(BotPears[418], 5);
	BotPears[419] = CreateActor(308, 1218.2460,-1352.8877,2001.0491,178.0994); // �������� Bot 1
	SetActorVirtualWorld(BotPears[419], 4);
	BotPears[420] = CreateActor(71, 1211.5765,-1357.6942,2001.0449,271.6186); // �������� Bot 2
	SetActorVirtualWorld(BotPears[420], 4);
	BotPears[421] = CreateActor(291, 1226.6830,-1361.0850,2001.0491,78.6269); // �������� Bot 3
	SetActorVirtualWorld(BotPears[421], 4);
	BotPears[422] = CreateActor(70, 1225.1354,-1360.9229,2001.0491,258.0002); // �������� Bot 4
	SetActorVirtualWorld(BotPears[422], 4);
	BotPears[423] = CreateActor(308, 1219.8785,-1350.2245,2001.0491,357.6178); // �������� Bot 5
	SetActorVirtualWorld(BotPears[423], 4);
	BotPears[424] = CreateActor(70, 1226.2745,-1411.0952,2001.0491,89.4486); // �������� Bot 6
	SetActorVirtualWorld(BotPears[424], 4);
	BotPears[425] = CreateActor(71, 1218.0801,-1410.1809,2001.0491,183.2813); // �������� Bot 7
	SetActorVirtualWorld(BotPears[425], 4);
	BotPears[426] = CreateActor(70, 1223.8677,-1442.9573,2001.0491,1.4010); // �������� Bot 8
	SetActorVirtualWorld(BotPears[426], 4);
	BotPears[427] = CreateActor(279, -2143.6426,78.1282,35.1633,184.4606); // �������� ���� Bot 1
	BotPears[428] = CreateActor(277, -2145.6177,64.1148,35.1633,68.6711); // �������� ���� Bot 2
	BotPears[429] = CreateActor(278, -2147.5535,64.6648,35.1633,252.2863); // �������� ���� Bot 3
	BotPears[430] = CreateActor(219, -2128.9646,66.1872,1403.3984,186.8929); // �������� ���� Bot 4
	SetActorVirtualWorld(BotPears[430], 4);
	BotPears[431] = CreateActor(277, -2128.8323,69.6934,1403.3984,358.9144); // �������� ���� Bot 5
	SetActorVirtualWorld(BotPears[431], 4);
	BotPears[432] = CreateActor(279, -2120.2576,60.6968,1403.3984,147.1225); // �������� ���� Bot 6
	SetActorVirtualWorld(BotPears[432], 4);
	BotPears[433] = CreateActor(304, -2120.9204,59.4988,1403.3984,328.5442); // �������� ���� Bot 7
	...
	BotPears[470] = CreateActor(171,1264.6343,1306.6207,1558.2009,275.2307); // ����� Bot 1 � ����
	SetActorVirtualWorld(BotPears[470], 85);
	BotPears[471] = CreateActor(11,1309.7184,1314.3702,1558.2090,272.7471); // ����� Bot 1 � ����
	SetActorVirtualWorld(BotPears[471], 85);
	BotPears[475] = CreateActor(164,1265.6527,-49.2240,1000.9280,1.3875); // ����� Bot 1
	SetActorVirtualWorld(BotPears[475], 3);
	BotPears[476] = CreateActor(164,1288.0977,-49.1689,1000.9280,7.3408); // ����� Bot 2
	SetActorVirtualWorld(BotPears[476], 3);
	BotPears[477] = CreateActor(163,1280.0337,-37.1167,1000.9280,181.2190); // ����� Bot 3
	SetActorVirtualWorld(BotPears[477], 3);
	BotPears[478] = CreateActor(189,1280.3707,-47.6048,1000.9280,314.8688); // ����� Bot 4
	SetActorVirtualWorld(BotPears[478], 3);
	BotPears[479] = CreateActor(59,1283.0580,-42.2432,1000.9280,15.6561); // ����� Bot 5
	SetActorVirtualWorld(BotPears[479], 3);
	BotPears[480] = CreateActor(98,1282.6345,-40.7867,1000.9280,194.8844); // ����� Bot 6
	SetActorVirtualWorld(BotPears[480], 3);
	BotPears[481] = CreateActor(141,1274.4423,-46.8282,1000.9280,20.3795); // ����� Bot 7
	SetActorVirtualWorld(BotPears[481], 3);
	BotPears[482] = CreateActor(43,1273.9204,-45.3367,1000.9280,204.5977); // ����� Bot 8
    ...
    BotPears[490] = CreateActor(42, 2858.4438,2213.5381,11.0265,140.1314);// ��������� LV-3 Bot 1
	BotPears[491] = CreateActor(50, 2859.2239,2221.5581,11.0265,3.3719);// ��������� LV-3 Bot 2
	BotPears[492] = CreateActor(151, 2867.3760,2215.5996,10.8613,178.8637);// ��������� LV-3 Bot 3
    ...
    BotPears[501] = CreateActor(71,1369.7183,-25.3327,1001.0717,2.6003); // ������������� Bot
    SetActorVirtualWorld(BotPears[501], 11);
	BotPears[502] = CreateActor(141,1631.0111,-2274.5208,13.5732,179.4451); // �������� Bot
	// ���� ���������
	if(IsACristmas())
	{
	...
	BotPears[507] = CreateActor(141,1274.8622,-21.0276,1000.9254,89.6971); // ����� ������ Bot
    SetActorVirtualWorld(BotPears[507], 100);
    BotPears[508] = CreateActor(150,1274.8622,-23.4229,1000.9254,87.1905); // ����� ������ Bot
    SetActorVirtualWorld(BotPears[508], 100);
    BotPears[509] = CreateActor(71,1255.7573,-24.2271,1000.9254,271.5772); // ����� ������ Bot
    SetActorVirtualWorld(BotPears[509], 100);
    BotPears[510] = CreateActor(71,1394.2056,-31.3340,1000.8779,335.8245); // ������ �����
    SetActorVirtualWorld(BotPears[510], 237);
    BotPears[511] = CreateActor(59,1400.3665,-30.2018,1000.8779,297.4525); // ������ �����
    SetActorVirtualWorld(BotPears[511], 237);
    BotPears[512] = CreateActor(147,1401.7723,-29.2993,1000.8779,122.6343); // ������ �����
    SetActorVirtualWorld(BotPears[512], 237);
    BotPears[513] = CreateActor(141,-1753.0793,885.3437,105.0207,182.7715); // ������ �����
    SetActorVirtualWorld(BotPears[513], 236);
    BotPears[514] = CreateActor(71,-1766.3875,890.2181,105.0248,270.9872); // ������ �����
    SetActorVirtualWorld(BotPears[514], 236);
    BotPears[515] = CreateActor(71,-1739.9305,877.7605,105.0148,91.1557); // ������ �����
    SetActorVirtualWorld(BotPears[515], 236);
    BotPears[516] = CreateActor(45, 565.910583,-1809.059204,6.062500,97.0); // ��� �����������
    BotPears[517] = CreateActor(140, 564.8656,-1809.2654,6.0625,280.8233); // ��� �����������
	BotPears[518] = CreateActor(270, 2530.8591,-1664.4253,15.1665,171.8431); // ��� ������� Grove
...
stock LoadZoneBot()
{
	new skini86[3],skini105[3],skini30[3],skini43[3],skini18[3],skini5[3],skini82[3],skini66[3],strFromFile2[128]; // ���������� ��� ������ ����������
	// ���������� 86
	...
	format(strFromFile2,sizeof(strFromFile2),"{ff9000}�������� �����\n{cccccc}��� ���������: %s",frakName[GZInfo[86][gFrakVlad]]);
	...
	format(strFromFile2,sizeof(strFromFile2),"{ff9000}�������� �����\n{cccccc}��� ���������: %s",frakName[GZInfo[105][gFrakVlad]]);
	...
	format(strFromFile2,sizeof(strFromFile2),"{ff9000}������\n{cccccc}��� ���������: %s",frakName[GZInfo[30][gFrakVlad]]);
	...
	format(strFromFile2,sizeof(strFromFile2),"{ff9000}���� �����\n{cccccc}��� ���������: %s",frakName[GZInfo[43][gFrakVlad]]);
	...
	format(strFromFile2,sizeof(strFromFile2),"{ff9000}��������������\n{cccccc}��� ���������: %s",frakName[GZInfo[18][gFrakVlad]]);
	...
	format(strFromFile2,sizeof(strFromFile2),"{ff9000}��������� �������\n{cccccc}��� ���������: %s",frakName[GZInfo[5][gFrakVlad]]);
	...
	format(strFromFile2,sizeof(strFromFile2),"{ff9000}�������� ����\n{cccccc}��� ���������: %s",frakName[GZInfo[82][gFrakVlad]]);
	...
	format(strFromFile2,sizeof(strFromFile2),"{ff9000}���������\n{cccccc}��� ���������: %s",frakName[GZInfo[66][gFrakVlad]]);
