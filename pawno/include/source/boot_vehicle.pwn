stock use_boot(playerid, v, inva, useinva)
{
	...
	if(thingPack == 4) return ErrorMessage(playerid, "{FF6347}�� �� ������ ����� ������ � ���� ��� � ���������\n\n������ ����� ������������� ������ � ��� ��� � ������"), i_resettabs(playerid);
	else if(thingPack == 2) // ���� ��� ����
	{
	    if(OnlineInfo[playerid][oInHandThing] >= 1 || Hand[playerid] >= 1 || Hold[playerid] >= 1 || GetPlayerWeapon(playerid) >= 2) return ErrorMessage(playerid, "{FF6347}� ��� ������ ���� [ ������� ��� ������ ]"), i_resettabs(playerid);
	    
	    if(IsHelmet(fpick)) thingPara = 3; // ����� ����������� 3 ��������
        if(IsArmor(fpick)) thingPara = 100; // ����� 100 ��

        OnlineInfo[playerid][oInHandThing][0] = fpick; // ID ��������
        OnlineInfo[playerid][oInHandThing][1] = fquan; // ����������
        OnlineInfo[playerid][oInHandThing][2] = thingPara; // ���������� ������
        OnlineInfo[playerid][oInHandThing][3] = thingQara; // ������ ����������
        OnlineInfo[playerid][oInHandThing][4] = thingType; // ��� ��������
        OnlineInfo[playerid][oInHandThing][5] = 2; // �������� ����
	...
	else if(thingType == 0 && thingPack == 0)
	{
		...
		{
		    DP[0][playerid] = inva;
		    format(store,sizeof(store),"{cccccc}����� ����� {ff9000}%s {cccccc}������� ����������\n\n�� ������ 1 � �� ������ 1.000.000",GetNameThing(0, fpick, thingType, thingPack));
			ShowDialog(playerid,896,DIALOG_STYLE_INPUT,"{ff9000}��������",store,"�������","������");
			return 1;
		}
		if(fpick == 35) // ������� � ���������
		{
		    ...
		    if(IsOnline(para1))
		    {
	    		format(store, sizeof(store), "����������� �� ��������� %s", playername(para1));
				SetPlayerChatBubble(playerid,store,COLOR_PURPLE,20.0,5000);
				format(store, sizeof(store), "* %s ����������� �� ��������� %s", playername(playerid), playername(para1));
				ProxDetector(20.0, playerid, store, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
	    		GameTextForPlayer(para1, RusToGame("~g~��� �������� �� ���������"), 7000, 4);
	    		EjectBoot(para1, v);
		    }
		    else ErrorMessage(playerid, "{FF6347}������! � ��������� ������ ���"), TakeBoot(v, fpick, fquan, thingType, inva), VehInfo[v][vPeople] = 0;
			i_resettabs(playerid);
			return 1;
		}
		else if(fpick == 36) // ���������� ������� � ��������� (��� ������)
	...
	// �������� �� ������� ������ ����������� (����� � �����)
	if(IsHelmet(fpick) && thingType == 2 && (PlayerInfo[playerid][pOdet][0] == fpick || PlayerInfo[playerid][pOdet][1] == fpick || PlayerInfo[playerid][pOdet][2] == fpick || PlayerInfo[playerid][pOdet][3] == fpick || PlayerInfo[playerid][pOdet][4] == fpick)) return ErrorMessage(playerid, "{FF6347}� ���� ��� ���� ���� �������");
	if(IsArmor(fpick) && thingType == 2 && PlayerInfo[playerid][pArmor] >= 1) return ErrorMessage(playerid, "{FF6347}� ���� ��� ���� ���� �������");

	// �������� �� ��������� �������
	if(JustOneThingInventory(fpick, thingType) && get_invent(playerid, fpick, thingType) > 0) return ErrorMessage(playerid, "{FF6347}� ���� ��� ���� ���� �������");
	...
	if(thingType == 0)
	{
	    if(friskKol[fpick] == 1)
		{
    		...
    		if(getQuan+fquan > getLimit) return format(store,sizeof(store),"{FF6347}� ��� ��� ����� � ���������\n����� ��� ����� ��������: %d\n\n{cccccc}�������� ����������� �� ������� �������� � �������� � ���������", getLimit), ErrorMessage(playerid, store);
 		}
	}

	new put_inva = GiveThingPlayer(playerid, fpick, fquan, thingPara, thingQara, thingType, thingPack, useinva);
	if(put_inva == -1) return ErrorMessage(playerid, "{FF6347}� ���� ��� ����� � ���������"); // �������� -1 � �����, ������ �� ����� ������, ���� ������ �������
    TakeBoot(v, fpick, fquan, thingType, inva);

    SaveInvent(playerid, put_inva); // ��������� ��, ��� ����� ����

    format(store,sizeof(store),"���� �� %s: %s", vehName[VehInfo[v][vModel]], GetNameThing(1, fpick, thingType, thingPack));
...
stock put_boot(playerid, inva, v, fpick, fquan, binva, thingType, thingPack)
{
	...
	if(fpick == 48 && thingType == 0 && OnlineInfo[playerid][oInflatableBoat] != NON) return ErrorMessage(playerid, "{FF6347}����� ����� �����, ������ ��� �������� � ��������"), i_resetveshi(playerid);
    if(NotGiveThing(fpick, thingType)) return ErrorMessage(playerid, "{FF6347}���� ������� ������ ����������, ��������� ��� �������"), i_resetveshi(playerid);
    if((v == LichCarID[playerid] || v == LichMotoID[playerid]) && GetPlayerVip(playerid) > 0) {}
	else
	{
		if(VehInfo[v][vCarLock] >= 1) return ErrorMessage(playerid, "{FF6347}��������� ������"), i_resetveshi(playerid);
	}
    new Float:Boot[3], Float:Bonnet[3];
	GetCoordBonnetVehicle(v, Bonnet[0], Bonnet[1], Bonnet[2]);
	GetCoordBootVehicle(v, Boot[0], Boot[1], Boot[2]);
	if(IsPlayerInRangeOfPoint(playerid, 1.0, Boot[0], Boot[1], Boot[2]) && !IsABootFront(v) || IsPlayerInRangeOfPoint(playerid, 1.0, Bonnet[0], Bonnet[1], Bonnet[2]) && IsABootFront(v))
	{
		...
		{
			if(IsA_Gen5(v) && binva >= 5) return ErrorMessage(playerid, "{FF6347}� ��������� �� ������� ����� [ Y >> ��������� >> ��������� �������� ]"), i_resetveshi(playerid);

			if(IsA_Gen10(v) && binva >= 10) return ErrorMessage(playerid, "{FF6347}� ��������� �� ������� ����� [ Y >> ��������� >> ��������� �������� ]"), i_resetveshi(playerid);

		 	if(IsA_Gen15(v) && binva >= 15) return ErrorMessage(playerid, "{FF6347}� ��������� �� ������� ����� [ Y >> ��������� >> ��������� �������� ]"), i_resetveshi(playerid);
		}
		...
		if(thingType == 0)
		{
			if(friskKol[fpick] == 1)
			{
			    if(VehInfo[v][vInvent][binva] != 0 && VehInfo[v][vInvent][binva] != PlayerInfo[playerid][pInven][inva]) return ErrorMessage(playerid, "{FF6347}��� ������ ������"), i_resetveshi(playerid);
			    if(thingPack == 0) quanThing = 1;
			    if(PlayerInfo[playerid][pInvenQuan][inva] < fquan) return ErrorMessage(playerid, "{FF6347}� ��� ��� ������ ���������� � ���� ������"), i_resetveshi(playerid);
			    new getQuan, getLimit;
			    v_limit(v, fpick, getQuan, getLimit);
			    if(getQuan+fquan > getLimit)
			    {
			        format(store,sizeof(store),"{FF6347}� ��������� ��� �����\n\n����� ��� ����� ��������: %d", getLimit);
		...
		if(VehInfo[v][vInvent][binva] > 0 && quanThing == 0) return ErrorMessage(playerid, "{FF6347}��� ������ ������"), i_resetveshi(playerid);
		...
		if(put_inva == -1) return ErrorMessage(playerid, "{FF6347}� ��������� ��� �����"), i_resetveshi(playerid); // �������� -1 � �����, ������ �� ����� ������, ���� ������ �������

		if(quanThing == 1) take_away(playerid, fquan, inva); // �������� ������� (�� ����������)
	 	else i_del(playerid, inva); // �������� ������� (�������)
	 	SaveInvent(playerid, inva); // ��������� ������ ��������� ������

		format(store,sizeof(store),"������� � �������� %d: %s", GetNameThing(1, fpick, thingType, thingPack));
		UserLog("putboot", PlayerInfo[playerid][pID], PlayerInfo[playerid][pName], PlayerInfo[playerid][pPlaIP], 0, "", "", fquan, store);

		i_resetveshi(playerid);
		i_resettabs(playerid);
    }
	else ErrorMessage(playerid, "{FF6347}�� ������ �� ����������");
	return put_inva;
}
stock PutThingBoot(v, thingId, quan, para, qara, thingType, thingPack, useinva) // ����� ������� � ��������
{
    new inva = -1;
	if(thingId == 0) return inva; // ������ ��� �� ������ ����� ���� (0 - �� ���������� ������ ��������)
	
	if(useinva == 999) // �� ����� � ����� ������ ������
	{
	    if(thingType == 0) // ������� �������
		{
		    if(friskKol[thingId] == 1) // ������� ����� ���������� (������������ � ���� ������)
		    {
		        new find;
		    	for(new i = 0; i < 20; i++)
				{
					if(VehInfo[v][vInvent][i] == thingId && VehInfo[v][vInvType][i] == thingType) // ���� ���, ��� ��� ������� �����
					{
					    inva = i;
		  				put_thing_boot(v, thingId, quan, para, 0, thingType, thingPack, i); // qara 0 - ��������� �������������� �������� �� ����� ����� ������ ����������
		  				find = 1;
			   			break;
					}
				}
	...
	else inva = put_thing_boot(v, thingId, quan, para, qara, thingType, thingPack, useinva); // ����� � ����� ������ ������
	return inva;
}
stock put_thing_boot(v, thingId, quan, para, qara, thingType, thingPack, i)
{
	if(VehInfo[v][vInvent][i] != 0 && VehInfo[v][vInvent][i] != thingId) return -1; // ������ �� ������, �� ������ ������

	if(VehInfo[v][vSost] > 0 && qara == VehInfo[v][vSost]) qara = 0; // ������� ������ ���������� ��������, ���� �� ����������� ����� ������

	VehInfo[v][vInvent][i] = thingId; // ������ ������� � ����
	VehInfo[v][vInv][i] += quan; // ������ ���������� � ����

	// (������� ������� ��� ���, ������ ����� ����������� �����������, Unix ����� �������� ���������, ������������ ������, ������������� �������� � ID ������, ��� ��������� ����������)
	if(PerishableThing(thingId, thingType)) // �������� �� ���������� �������� - � ��� ������������ Unix (�������� ����������� ������� � �������, ��������� ������ ��)
	{
	...
	VehInfo[v][vInvQara][i] = qara; // ������ ���������� ��������
	VehInfo[v][vInvType][i] = thingType; // ��� ��������
	VehInfo[v][vInvPack][i] = thingPack; // �������� ��������
...
stock mix_boot(playerid, v, getinva, putinva) // ���������� ���������
{
	if(OnlineInfo[playerid][oShowInterfaceVeh] != 9999)
	{
		...
		if(quanPlayer >= 2)
		{
			format(store, sizeof(store), "{FF6347}�������� ������������� %d ���. [ ����������� �������� ���������� ]", quanPlayer-1);
			ErrorMessage(playerid, store);
			i_resettabs(playerid);
			return 1;
		}
...
stock shift_boot(playerid, v, getinva, putinva) // ����������� ��������� ������ ��������� ���������� (� ����� ������ �� ������)
{
	if(OnlineInfo[playerid][oShowInterfaceVeh] != 9999)
	{
		if(VehInfo[v][vInvent][getinva] == 0) return i_resettabs(playerid);
		...
		if(VehInfo[v][vUpgrade] == 0)
		{
			if(IsA_Gen5(v) && putinva >= 5) return ErrorMessage(playerid, "{FF6347}� ��������� �� ������� ����� [ Y >> ��������� >> ��������� �������� ]"), i_resetveshi(playerid);
			if(IsA_Gen10(v) && putinva >= 10) return ErrorMessage(playerid, "{FF6347}� ��������� �� ������� ����� [ Y >> ��������� >> ��������� �������� ]"), i_resetveshi(playerid);
		 	if(IsA_Gen15(v) && putinva >= 15) return ErrorMessage(playerid, "{FF6347}� ��������� �� ������� ����� [ Y >> ��������� >> ��������� �������� ]"), i_resetveshi(playerid);
		}
...
stock put_bootbox(playerid, v) // ����� ���� � ��������
{
	if(OnlineInfo[playerid][oInHandThing][0] > 0 && OnlineInfo[playerid][oInHandThing][5] == 2)
	{
	    ...
	    if(put_inva == -1) return ErrorMessage(playerid, "{FF6347}� ��������� ��� �����");
	    
	    InHandClear(playerid);
		SetPlayerChatBubble(playerid,"����� ���� � ��������",COLOR_PURPLE,20.0,3000);
		RemovePlayerAttachedObject(playerid,1), PPP15[playerid] = 0;
   		ClearAnimations(playerid);
   		ClearAnim(playerid);
   		PlayerPlaySound(playerid,1053,0,0,0);
	}
	else ErrorMessage(playerid, "{FF6347}� ��� � ����� ��� ����� {cccccc}[ ������� ��������: N >> �������� ]");
	return 1;
}
stock item_boot(playerid, v, fpick, fquan, inva, fpara, thingType, thingPack)
{
	...
	else
	{
		...
		if(thingPack == 1) yesFindModel = 19054; // �������
		else if(thingPack == 2) yesFindModel = 3014; // ����
		else if(thingPack == 3) yesFindModel = 2060; // �����
		else if(thingPack == 0) // ��� ��������
		{
			if(thingType == 0) // ������� �������
			{
			...
			if(thingType == 2) yesFindModel = fpick; // ����������
		 	if(thingType == 3) yesFindModel = fpick; // ������
			if(thingType == 4) yesFindModel = fpick; // ������
		}
...
stock v_limit(v, thingId, &getQuan, &getLimit) // ��������� ������ ����
{
	new lim[INVENTER];
	for(new i = 0; i < INVENTER; i++) lim[i] = 1;
	lim[8] = 100, lim[19] = 100, lim[41] = 1000, lim[25] = 1000000; // �������, �������, ����������� �����, ������ 1��
