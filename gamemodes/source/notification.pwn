...
new Text:MindDraw[5];
new PlayerText:HintButton;

new PlayerText:MindDraw1;
new PlayerText:MindDraw2;

forward SendMindMessage(playerid, const text[], const texttwo[]);
public SendMindMessage(playerid, const text[], const texttwo[])
{
	...
	MindTimer[playerid] = SetTimerEx("DelMind", 7000, false, "d", playerid);
