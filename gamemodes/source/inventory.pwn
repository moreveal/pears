...
#define INVENTER 198 // Максимальный ID (обычный предмет)
...
new fdrawName[][] = // Название Вещи
{
	...
	"PEM.KOMЊ‡EKЏ KAЏEPO‹","HAMA3‡‘K","P‘ЂKA", "KOPM ѓ‡• P‘ЂOK","ЊAKEЏ", "ЂA‡OHЌ…K C KPACKO†","Џa—ћe¦ka A¦akњ"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"REPAIR KIT BOAT","NAMAZLYK","AQUA FISH", "FISH FOOD", "PACKAGE", "CANS OF PAINT","PILL ATTACK"
};
new friskName[][] = // Название Вещи
{
	...
	"Рем.комплект Катеров","Намазлык","Аквариумная рыбка", "Корм для рыбок", "Пакет", "Балончик с краской","Таблетка Атаки" // 192 - 198
};
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	2000,1500,3000,10,100,100,100 // 198
};
