...
#define INVENTER 189 // Максимальный ID (обычный предмет)
...
new fdrawName[][] = // Название Вещи
{
	...
	"3AЊЌACЏ’ ЂOMЂ‘","PEMOHTHSN_HA6OP","KPACKA_DLR_ABTOMO6NLR","ABTOMO6NLJHSE_DNCKN","FNDPABLNKA","3AKNCJ_A3OTA","DETALJ_TUHNHFA"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"BOMB SPARE PART","REPAIR KIT","CAR PAINT","CAR WHEELS","HYDRAULICS","NITROUS OXIDE","TUNING COMPONENT"
};
new friskName[][] = // Название Вещи
{
	...
	"Запчасть бомбы","Ремонтный Набор","Краска для автомобиля","Автомобильные диски","Гидравлика","Закись Азота","Деталь Тюнинга" // 182 - 188
};
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	1000,1500,3500,1500,7500,10000,10000 // 187
};
