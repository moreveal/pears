...
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	19569,19847,12382,12382,12381,12497,12498,12499,12495,12496, // 261 - 270
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	-1,-1,50000,1000,1000,1000,-1,-1,10000 // 278
};
...
stock PerishableThing(i, type) //  Проверка на портящиеся продукты
{
	...
	|| i == 168 || i == 169 || i == 170 || i == 171 || i == 172 || i == 173 || i == 174 || i == 233 || i == 236 || i == 261 || i == 262)) return 1;
	return 0;
}
