...
#define INVENTER 196 // Максимальный ID (обычный предмет)
...
new fdrawName[][] = // Название Вещи
{
	...
	"PEM.KOMЊ‡EKЏ KAЏEPO‹","HAMA3‡‘K","P‘ЂKA", "KOPM ѓ‡• P‘ЂOK"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"REPAIR KIT BOAT","NAMAZLYK","AQUA FISH", "FISH FOOD"
};
new friskName[][] = // Название Вещи
{
	...
	"Рем.комплект Катеров","Намазлык","Аквариумная рыбка", "Корм для рыбок" // 192 - 195
};
