...
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"REPAIR KIT BOAT","NAMAZLYK","AQUA FISH", "FISH FOOD", "PACKAGE", "CANS OF PAINT"
};
new friskName[][] = // Название Вещи
{
	...
	"Рем.комплект Катеров","Намазлык","Аквариумная рыбка", "Корм для рыбок", "Пакет", "Балончик с краской" // 192 - 197
};
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	19921,2833,1599,19561,1575,365 // 192 - 197
};
