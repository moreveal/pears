...
new friskName[][] = // Название Вещи
{
	...
	"Термитная смесь", "Алюминий" // 237-238
};
...
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	18875,364,330,11746,11746,2967,19921,19843 // 231 - 238
};
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	30000,85000,120000,10000,10000,60000,-1,-1 // 231 - 238
};
