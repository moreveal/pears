...
new fdrawName[][] = // Название Вещи
{
	...
	"ѓe¦ek¦op paљapoў 1 yp.", "ѓe¦ek¦op paљapoў 2 yp.", "‚ћyҐњћka paљapoў", "KEY CASE MANIAC", "KEY CASE YAKUZA"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"RADAR Detector", "RADAR Detector 2", "RADAR Jammer", "KEY CASE MANIAC", "KEY CASE YAKUZA"
};
...
new friskName[][] = // Название Вещи
{
	...
	"Детектор радаров", "Улучшенный детектор радаров", "Глушилка радаров", "Ключ от Кейса Маньяка", "Ключ от Кейса Yakuza" // 231 - 235
};
...
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	18875,364,330,11746,11746 // 231 - 235
};
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	30000,85000,120000,10000,10000 // 231 - 235
};
...
stock PerishableThing(i, type) //  Проверка на портящиеся продукты
{
	...
	|| i == 168 || i == 169 || i == 170 || i == 171 || i == 172 || i == 173 || i == 174 || i == 233)) return 1;
	return 0;
}
