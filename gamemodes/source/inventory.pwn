...
new fdrawName[][] = // Название Вещи
{
	...
	"ЏEP–…ЏHA•_C–EC’", "A‡”M…H…†", "‚Oѓ„O ЊPOЊYCK", "Kњћoўa¦¦", "KEY CASE GRAVES", "ЌEPEЊ_OC…P…CA", "HEKPOHO–…KOH", "ЊPOK‡AѓK…"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"THERMITE MIXTURE", "ALUMINIUM", "GODJO PASS", "KILOWATT", "KEY CASE GRAVES", "OSIRIS SKULL", "NECRONOMICON", "PADS"
};
...
new friskName[][] = // Название Вещи
{
	...
	"Термитная смесь", "Алюминий", "Пропуск Годжо", "Киловатт", "Ключ от Похоронного Кейса", "Череп Осириса", "Некрономикон", "Прокладки" // 237-244
};
...
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	12353,12341,12342,12354 // 241 - 244
};
