...
new fdrawName[][] = // Название Вещи
{
	...
	"KVR Perfomance","Brembo","Wilwood", "Philin Customs", "ѓOMKPAЏ", "ЂPOHEЊ‡EHKA 1000", "ЂPOHEЊ‡EHKA 2000", "ЂPOHEЊ‡EHKA 3000"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"ACT","Clutch Masters","Jacson Raceing","HPRacing","Ibach Springs","KONI suspension","BILSTEIN","YKOHAMA","TOYO","Falken Tire",
	"KVR Perfomance","Brembo","Wilwood", "Philin Customs", "JACK", "ARMORED FILM 1000", "ARMORED FILM 2000", "ARMORED FILM 3000"
};
new friskName[][] = // Название Вещи
{
	...
	"KVR Perfomance","Brembo","Wilwood", "Philin Customs", "Домкрат", "Бронеплёнка 1000", "Бронеплёнка 2000", "Бронеплёнка 3000" // 221-228
};
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	19917,19917,19917,19917,19900,1649,1649,1649 // 221-228
};
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	-1,-1,-1,-1, 50000,50000,100000,200000,400000, // 210
	100000,200000,400000,300000,600000,1200000,300000,600000,1200000,50000, // 220
	100000,200000,400000,100000000,5000,1400000,2800000,4200000 // 228
};
