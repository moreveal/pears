...
new fdrawName[][] = // Название Вещи
{
	...
	"KVR Perfomance","Brembo","Wilwood", "Philin Customs"
};
...
new friskName[][] = // Название Вещи
{
	...
	"KVR Perfomance","Brembo","Wilwood", "Philin Customs"// 221-224
};
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	11715,1581,1550,363,19917,19917,19917,19917,19917,19917, // 202 - 210
	19917,19917,19917,19917,19917,19917,19917,19917,19917,19917, // 211 - 220
	19917,19917,19917,19917 // 221-224
};
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	-1,-1,-1,-1, 50000,50000,100000,200000,400000,50000, // 211
	100000,200000,400000,300000,600000,1200000,300000,600000,1200000,50000, // 221
	100000,200000,400000,100000000 // 224
};
