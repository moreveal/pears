...
new fdrawName[][] = // Название Вещи
{
	...
	"ЏEP–…ЏHA•_C–EC’", "A‡”M…H…†", "‚Oѓ„O ЊPOЊYCK"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"THERMITE MIXTURE", "ALUMINIUM", "GODJO PASS"
};
...
new friskName[][] = // Название Вещи
{
	...
	"Термитная смесь", "Алюминий", "Пропуск Годжо" // 237-239
};
...
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	18875,364,330,11746,11746,2967,19921,19843,2684 // 231 - 239
};
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	30000,85000,120000,10000,10000,60000,-1,-1,1 // 231 - 239
};
