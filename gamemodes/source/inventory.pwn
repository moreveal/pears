...
new fdrawName[][] = // Название Вещи
{
	...
	"‹…‡KA", "KAPЏ‘ ѓOCЏYЊA Џ”P’M‘", "MEЋOK C ѓEH’‚AM…", "ЂOMЂA ‡…ЊYЌKA","3AЊЌACЏ…"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"FORK","PRISON ACCESS CARDS","BAG OF MONEY","STICKY BOMB","PARTS"
};
new friskName[][] = // Название Вещи
{
	...
	"Вилка","Карта доступа Тюрьмы","Мешок с деньгами","Бомба липучка", "Запчасти" // 202 - 206
};
