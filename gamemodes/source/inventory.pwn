...
new fdrawName[][] = // Название Вещи
{
	...
	"ЏEP–…ЏHA•_C–EC’", "A‡”M…H…†", "‚Oѓ„O ЊPOЊYCK", "Kњћoўa¦¦", "KEY CASE GRAVES", "ЌEPEЊ_OC…P…CA", "HEKPOHO–…KOH","MEX 3A†‰A", "MEX ‡…C‘", "ЋKYPA ‹O‡KA", "ЋKYPA MEѓ‹Eѓ•", "KO„A O‡EH•","ЊPOK‡AѓK…"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"THERMITE MIXTURE", "ALUMINIUM", "GODJO PASS", "KILOWATT", "KEY CASE GRAVES", "OSIRIS SKULL", "NECRONOMICON", "RABBIT FUR", "FOX FUR", "WOLF SKIN", "BEAR SKIN", "DEER SKIN", "PADS"
};
...
new friskName[][] = // Название Вещи
{
	...
	"Термитная смесь", "Алюминий", "Пропуск Годжо", "Киловатт", "Ключ от Похоронного Кейса", "Череп Осириса", "Некрономикон", "Мех Зайца", "Мех Лисы", "Шкура Волка", "Шкура Медведя", "Кожа Оленя","Прокладки" // 237-249
};
...
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	12353,12341,12342,12387,12388,12385,12386,12384,12354 // 241 - 249
};
...
stock CheckThingQuan(t) // Имеет ли предмет количество (1 да, 0 нет)
{
	...
	|| t == 181 || t == 183 || t >= 190 && t <= 192 || t == 197 || t == 225 || t == 230 || t == 238) ? 1 : 0;
}
