...
new fdrawName[][] = // Название Вещи
{
	...
	"ЏEP–…ЏHA•_C–EC’", "A‡”M…H…†", "‚Oѓ„O ЊPOЊYCK", "Kњћoўa¦¦", "KEY CASE GRAVES", "ЌEPEЊ_OC…P…CA", "HEKPOHO–…KOH","MEX 3A†‰A", "MEX ‡…C‘", "ЋKYPA ‹O‡KA", "ЋKYPA MEѓ‹Eѓ•", "KO„A O‡EH•"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"THERMITE MIXTURE", "ALUMINIUM", "GODJO PASS", "KILOWATT", "KEY CASE GRAVES", "OSIRIS SKULL", "NECRONOMICON", "RABBIT FUR", "FOX FUR", "WOLF SKIN", "BEAR SKIN", "DEER SKIN"
};
...
new friskName[][] = // Название Вещи
{
	...
	"Термитная смесь", "Алюминий", "Пропуск Годжо", "Киловатт", "Ключ от Похоронного Кейса", "Череп Осириса", "Некрономикон", "Мех Зайца", "Мех Лисы", "Шкура Волка", "Шкура Медведя", "Кожа Оленя" // 237-248
};
...
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	12353,12341,12342,12387,12388,12385,12386,12384 // 241 - 248
};
