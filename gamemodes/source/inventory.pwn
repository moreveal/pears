...
new fdrawName[][] = // Название Вещи
{
	...
	"‹…‡KA", "KAPЏ‘ ѓOCЏYЊA Џ”P’M‘", "MEЋOK C ѓEH’‚AM…", "ЂOMЂA ‡…ЊYЌKA"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"FORK","PRISON ACCESS CARDS","BAG OF MONEY","STICKY BOMB"
};
new friskName[][] = // Название Вещи
{
	...
	"Вилка","Карта доступа Тюрьмы","Мешок с деньгами","Бомба липучка" // 202 - 205
};
...
{
    0,60,20000,5,3000,1000,500,2000,3000,700,1, // 10
