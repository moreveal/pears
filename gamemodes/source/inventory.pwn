...
new fdrawName[][] = // Название Вещи
{
	...
	"ЏEP–…ЏHA•_C–EC’", "A‡”M…H…†", "‚Oѓ„O ЊPOЊYCK", "Kњћoўa¦¦"
};
new fdrawNameEN[][] = // Название Вещи на Английском
{
	...
	"THERMITE MIXTURE", "ALUMINIUM", "GODJO PASS", "KILOWATT"
};

// TODO: При добавлении новых предметов заменить 5, 180 и 198 (Таблетки защиты и атаки, вырезанная система)
new friskName[][] = // Название Вещи
{
	...
	"Термитная смесь", "Алюминий", "Пропуск Годжо", "Киловатт" // 237-240
};
...
stock TopThing(i)
{
	...
	|| i == 222 || i == 223 || i == 224 || i == 239) return true;
	return false;
}
