...
new fdrawName[][] = // Название Вещи
{
	...
	"ѓe¦ek¦op paљapoў 1 yp.", "ѓe¦ek¦op paљapoў 2 yp.", "‚ћyҐњћka paљapoў"
};
...
new friskName[][] = // Название Вещи
{
	...
	"Детектор радаров", "Улучшенный детектор радаров", "Глушилка радаров" // 231-233
};
