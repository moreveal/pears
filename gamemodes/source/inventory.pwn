...
#define INVENTER 202 // Максимальный ID (обычный предмет)
...
new friskName[][] = // Название Вещи
{
	...
	"Рем.комплект Катеров","Намазлык","Аквариумная рыбка", "Корм для рыбок", "Пакет", "Балончик с краской","Таблетка Атаки","Обычная Сигнализация","Улучшенная Сигнализация","Металическая Труба" // 192 - 201
};
new friskPick[] = // ID Модельки в Инвентаре (обычный предмет)
{
	...
	19921,2833,1599,19561,1575,365,1241,1614,1615,1135 // 192 - 200
};
...
new friskDefault[] = // Гос. стоимости предметов
{
	...
	2000,1500,3000,10,100,100,100,10000,50000, 1 // 200
};
