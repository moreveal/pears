...
stock IsAVehExisting(v)
{
    ...
    || v >= 2000 && v <= 2126) return 1; // Кастомный транспорт пирса
...
stock GetVehicleClass(m)
{
	...
	|| m == 2088 || m == 2095 || m == 2125 || m == 2126) class = 6;
	...
	|| m == 2047 || m == 2060 || m == 2096 || m == 2100 || m == 2101 || m == 2102 || m == 2108 || m == 2122) class = 7;

    // Новый класс, типо лимитированные (8)
    else if(m == 2063 || m == 2064 || m == 2120 || m == 2124) class = 8;
