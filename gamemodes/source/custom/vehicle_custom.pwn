...
new vehNameCustom[][] =
{
    ...
    "Audi RS6 C7", // 2186
    "Mercedes-Benz W210 E55 AMG", // 2187
    "Lexus LS500" // 2188
};
...
new vehSummaCustom[] = // Гос цены на авто (Дефолтные) Кастомный транспорт
{
    ...
    15000000, // "Nissan Skyline R32 GT-R" // 2185
    18000000, // "Audi RS6 C7", // 2186
    12000000, // "Mercedes-Benz W210 E55 AMG", // 2187
    20000000, // "Lexus LS500" // 2188
};
...
new vehSummaGoldCustom[] = // Гос цены на авто в голде (Дефолтные) Кастомный транспорт
{
    ...
    3750, // "Nissan Skyline R32 GT-R" // 2185
    4500, // "Audi RS6 C7", // 2186
    3000, // "Mercedes-Benz W210 E55 
    5000, // "Lexus LS500" // 2188
    // КОЭФ 4000
};
...
stock AddCustomVehicle() // Добавляем тс на карту
{
    ...
    AddVehicleSyncModel(560, 2186); // "Audi RS6 C7", // 2186
    AddVehicleSyncModel(551, 2187); // "Mercedes-Benz W210 E55
    AddVehicleSyncModel(580, 2188); // "Lexus LS500" // 2188
    return 1;
}
...
stock GetVehicleClass(m)
{
    ...
    || m == 2146 || m == 2150 || m == 2171 || m == 2188) class = 1;
    ...
    || m == 2166 || m == 2173 || m == 2106 || m == 2186 ) class = 2;
    ...
    || m == 2154 || m == 2155 || m == 2156 || m == 2157 || m == 2158 || m == 2172 || m == 2185 || m == 2187) class = 3;
...
{
    if(model == 12246 || model >= 12500 && model <= 12508) return true;
    return false;
}
