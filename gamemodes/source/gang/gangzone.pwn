...
#define GZONES 95 // Количество гангзон на сервере
...
new GangZone[GZONES][GANGZONEENUM] =
{
	...
	{ 2654.23779296875, -1055.9376831054688, 2764.23779296875, -945.9376831054688, 13 },
	{ 2764.23779296875, -1055.9376831054688, 2874.23779296875, -945.9376831054688, 13 },
	{ 2764.23779296875, -1165.9376831054688, 2874.23779296875, -1055.9376525878906, 13 },
	{ 2764.23779296875, -1825.9375, 2874.23779296875, -1715.9375, 14 },
	{ 2764.23779296875, -1935.9375, 2874.23779296875, -1825.9375, 14 },
	{ 2764.23779296875, -2045.9375, 2874.23779296875, -1935.9375, 14 },
	{ 2764.23779296875, -2155.9375, 2874.23779296875, -2045.9375, 14 },
	...
	{ 1884.23828125, -1055.9376831054688, 1994.23828125, -945.9376831054688, 15 },
...
stock CheckGangZone() // Распределение результатов по окончанию капта
{
	...
	// Назначаем наркопритоны/лаборатории победившей банде
	for (new i = 0; i < MAX_NARCO_SPOTS; i++)
	{
		if (!NarcoSpotIsExists(i)) continue;
		new fractionid = NarcoSpotGetGang(NarcoSpotInfo[i][nstPosition][0], NarcoSpotInfo[i][nstPosition][1], NarcoSpotInfo[i][nstPosition][2]);
		if (fractionid < 1) continue;
	...
	new atext[24], btext[30], string[144];
	switch(random(7))
 	{
...
stock IsAGhetto(playerid) // Проверка, находится ли игрок на территории гетто
{
	...
	if(GetPlayerVirtualWorld(playerid) == 0 && GetPlayerInterior(playerid) == 0
		&& IsPlayerInSquare(playerid, 2416.0, -1740.0, 2562.0, -1603.0) // Grove
		&& IsPlayerInSquare(playerid, 2178.0, -1502.0, 2324.0, -1365.0) // Ballas
		&& IsPlayerInSquare(playerid, 2404.0, -2060.0, 2560.0, -1923.0) // Vagos
		&& IsPlayerInSquare(playerid, 1651.0, -2160.0, 1968.0, -2012.0) // Aztecas
	) yesGhetto = 1;
