...
{
    "Навык Моряка", "Навык Космонавта", "Навык Сексуальности", "Навык Инженера", "Навык Охотника", "Навык Фермера", "Навык Взломщика", "Навык Химика", "Навык Автомеханика", "Навык Сыщика"
};
