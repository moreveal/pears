...
new BattlePassWeeklyTaskDescription[][] =
{
    ...
    "- Отправляйтесь в клуб (/gps > Развлечения > Клуб/бар). И дайте на ротан проститутке :)", // 29
    "- Найдите человека для данного занятия, и воспользуйтесь командой (/sex)", // 30
...
new BattlePassWeeklyTaskName[][] =
{
    ...
    "Слушать Радио сервера (минут)", // 6
    "Получить повышение репутации", // 7
    "Выйграть в казино за раз 1.000.000", // 8
    "Сбить НЛО", // 9
    "Выйграть Доминика", // 10
    "Убить маньяка", // 11
    ...
    "Успешно воспользоваться проституткой в клубе", // 29
    "Успешно заняться половым контактом", // 30
    "Скрафтить предметов", // 31
    "Приготовить на плите блюд", // 32
    "Завершите гонок", // 33
    "Займите 1 место в гонке", // 34
    "Поучаствуйте в митинге (секунд)", // 35
...
new BattlePassAwarsdItem[MAX_LEVEL_BATTLEPASS][20] =
{
    ...
    { 12207, 2, 1, 0, 0,     0, 0, 0, 0, 0,      12249, 2, 1, 0, 0,      0, 0, 0, 0, 0 }, // 15
