...
stock LoadBot()
{
    ...
    if(IsANewYear())
    {
        ...
        BotPears[264] = CreateDynamicActor(657, 3302.1863,-401.8705,8.6501,356.6904); // Йольский Парень 
        BotPears[265] = CreateDynamicActor(657, 3289.0723,-404.1032,8.5798,2.9571); // Йольский Парень 
        BotPears[266] = CreateDynamicActor(657, 3273.0542,-401.0622,8.3631,332.9003); // Йольский Парень 
        BotPears[267] = CreateDynamicActor(657, 3266.8120,-389.1149,8.4329,115.781); // Йольский Парень 
    }
	LoadAnimBot();
