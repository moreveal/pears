...
stock CheckAutoInRangeService(playerid)
{
    ...
    if(GetVehicleClass(VehInfo[v][vModel]) != GetVehicleClass(VehInfo[veh][vModel])) return ErrorMessage(playerid, "{FF6347}Этот транспорт другого класса, переносить характеристик невозможен!");
