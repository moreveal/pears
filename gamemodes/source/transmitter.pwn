...
stock dialogCase_Transmitter(playerid, dialogid, response, listitem)
{
    ...
    else if(dialogid == 506)
    {
        ...
        if(response)
        {
            ...
            {
                if(listitem >= 1 && PlayerInfo[playerid][pDivision][1] == 0) return ErrorMessage(playerid, "{FF6347}Ошибка! У вас нет скрытой подфракции");
