...
stock UpdateOdet(playerid, sl)
{
	...
	mysql_format(pearsq, string_mysql, sizeof(string_mysql), "UPDATE `pp_igroki` SET `Odet%d`='%d',`Odet_X%d`='%f',`Odet_Y%d`='%f',`Odet_Z%d`='%f',\
...
stock UpdateAllOdet(playerid)
{
    ...
    mysql_format(pearsq, string_mysql,sizeof(string_mysql),"UPDATE `pp_igroki` SET `Odet1`='%d',`Odet_X1`='%f',`Odet_Y1`='%f',`Odet_Z1`='%f',\
    ...
    {
        mysl = i + 1;
        mysql_format(pearsq, string_mysql,sizeof(string_mysql),"%s, `Odet%d`='%d',`Odet_X%d`='%f',`Odet_Y%d`='%f',`Odet_Z%d`='%f',\
    ...
    mysql_format(pearsq, string_mysql,sizeof(string_mysql),"%s WHERE `user_id`='%d'", string_mysql, PlayerInfo[playerid][pID]); // 19 + 11
