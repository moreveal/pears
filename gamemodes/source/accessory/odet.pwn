...
{
	new mysl = sl + 1;
	format(big_query, sizeof(big_query), "UPDATE `pp_igroki` SET `Odet%d`='%d',`Odet_X%d`='%f',`Odet_Y%d`='%f',`Odet_Z%d`='%f',\
	`Odet_rX%d`='%f',`Odet_rY%d`='%f',`Odet_rZ%d`='%f',`Odet_sX%d`='%f',`Odet_sY%d`='%f',`Odet_sZ%d`='%f',`OdetPara%d`='%d',`OdetQara%d`='%d',`OdetBone%d`='%d' WHERE `id`='%d'",
	...
	mysl,PlayerInfo[playerid][pOdetBone][sl],PlayerInfo[playerid][pID]);
...
{
    format(big_query,sizeof(big_query),"UPDATE `pp_igroki` SET `Odet1`='%d',`Odet_X1`='%f',`Odet_Y1`='%f',`Odet_Z1`='%f',\
	...
	PlayerInfo[playerid][pOdetBone][0]);

    new mysl;
	for(new i = 1; i < MAX_ODET; i++)
    {
        mysl = i + 1;
        format(big_query,sizeof(big_query),"%s, `Odet%d`='%d',`Odet_X%d`='%f',`Odet_Y%d`='%f',`Odet_Z%d`='%f',\
	        `Odet_rX%d`='%f',`Odet_rY%d`='%f',`Odet_rZ%d`='%f',`Odet_sX%d`='%f',`Odet_sY%d`='%f',`Odet_sZ%d`='%f',`OdetPara%d`='%d',`OdetQara%d`='%d',`OdetBone%d`='%d'", big_query,
        ...
        mysl,PlayerInfo[playerid][pOdetBone][i]);
    }
