...
static const pressSeatObjects[][e_pressSeatObjects] = {
	...
	{ 12199, {180.8906, 0.6490, -0.4983, 1.0106} },
	{ 12198, {179.3477, 0.8580, -0.6252, 1.0407}, {180.6010, 0.9964, -1.4539, 1.0407} },
	{ 12279, {183.1078, 0.5518, 0.4035, 0.5404}, {182.4812, 0.5924, -0.4490, 0.5404} },
	{ 12278, {182.7710, 0.5673, 0.7969, 0.5205}, {182.1444, 0.6052, 0.0142, 0.5205}, {181.5176, 0.6264, -0.8136, 0.5205} },
	{ 12277, {181.5178, 0.6064, -0.0209, 0.5205} },
	{ 12230, {180.2646, 0.6774, -0.6866, 1.0310}, {177.1313, 0.6771, -1.4352, 1.0310} },
...
stock NoSit(playerid) // Позиции, где sit работать не будет
{
	...
	|| ExitDom(playerid) // Дом рядом
	|| (GetPlayerVirtualWorld(playerid) >= 3000 && GetPlayerVirtualWorld(playerid) < 4000) && IsPlayerInRangeOfPoint(playerid,4.0,BizzInfo[GetPlayerVirtualWorld(playerid)-3000][bInteriorX], BizzInfo[GetPlayerVirtualWorld(playerid)-3000][bInteriorY], BizzInfo[GetPlayerVirtualWorld(playerid)-3000][bInteriorZ]))
	{
		return 1;
	}
	return 0;
