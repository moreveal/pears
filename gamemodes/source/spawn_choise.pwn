    ...
    if(dialogid == 503)
    {
        ...
        if(response)
        {
            ...
            else if(spawnId == 5) // Room
            {
                ...
                DP[0][playerid] = quan;
                ShowDialog(playerid,APARTMENTS_DIALOG_SPAWNCHOICE,DIALOG_STYLE_TABLIST,"{cccccc}Мои Квартиры",lines,"Выбрать","Отмена");
            }
...
stock CreateDrawSpawnChoise()
{
    ...
    TextDrawAlignment(SpawnChoiseDraw[0], TEXT_DRAW_ALIGN:1);
    TextDrawColour(SpawnChoiseDraw[0], 421075440);
    TextDrawSetShadow(SpawnChoiseDraw[0], 0);
    TextDrawSetOutline(SpawnChoiseDraw[0], 0);
    TextDrawFont(SpawnChoiseDraw[0], TEXT_DRAW_FONT:4);
    ...
    TextDrawBackgroundColour(SpawnChoiseDraw[1], 0);
    TextDrawLetterSize(SpawnChoiseDraw[1], 1.0, 1.0);
    TextDrawTextSize(SpawnChoiseDraw[1], 43.000000, 48.0);
    TextDrawAlignment(SpawnChoiseDraw[1], TEXT_DRAW_ALIGN:1);
    TextDrawColour(SpawnChoiseDraw[1], -1);
    TextDrawUseBox(SpawnChoiseDraw[1], true);
    TextDrawBoxColour(SpawnChoiseDraw[1], 0);
    TextDrawSetShadow(SpawnChoiseDraw[1], 0);
    TextDrawSetOutline(SpawnChoiseDraw[1], 0);
    TextDrawFont(SpawnChoiseDraw[1], TEXT_DRAW_FONT:5);
    ...
    TextDrawAlignment(SpawnChoiseDraw[2], TEXT_DRAW_ALIGN:2);
    TextDrawColour(SpawnChoiseDraw[2], -1061109505);
    TextDrawSetShadow(SpawnChoiseDraw[2], 1);
    TextDrawSetOutline(SpawnChoiseDraw[2], 0);
    TextDrawBackgroundColour(SpawnChoiseDraw[2], 51);
    TextDrawFont(SpawnChoiseDraw[2], TEXT_DRAW_FONT:1);
    TextDrawSetProportional(SpawnChoiseDraw[2], true);
    ...
    TextDrawAlignment(SpawnChoiseDraw[3], TEXT_DRAW_ALIGN:1);
    TextDrawColour(SpawnChoiseDraw[3], 421075440);
    TextDrawSetShadow(SpawnChoiseDraw[3], 0);
    TextDrawSetOutline(SpawnChoiseDraw[3], 0);
    TextDrawFont(SpawnChoiseDraw[3], TEXT_DRAW_FONT:4);
    ...
    TextDrawBackgroundColour(SpawnChoiseDraw[4], 0);
    TextDrawLetterSize(SpawnChoiseDraw[4], 1.0, 1.0);
    TextDrawTextSize(SpawnChoiseDraw[4], 43.000000, 48.0);
    TextDrawAlignment(SpawnChoiseDraw[4], TEXT_DRAW_ALIGN:1);
    TextDrawColour(SpawnChoiseDraw[4], -1);
    TextDrawUseBox(SpawnChoiseDraw[4], true);
    TextDrawBoxColour(SpawnChoiseDraw[4], 0);
    TextDrawSetShadow(SpawnChoiseDraw[4], 0);
    TextDrawSetOutline(SpawnChoiseDraw[4], 0);
    TextDrawFont(SpawnChoiseDraw[4], TEXT_DRAW_FONT:5);
    ...
    TextDrawAlignment(SpawnChoiseDraw[5], TEXT_DRAW_ALIGN:2);
    TextDrawColour(SpawnChoiseDraw[5], -1061109505);
    TextDrawSetShadow(SpawnChoiseDraw[5], 1);
    TextDrawSetOutline(SpawnChoiseDraw[5], 0);
    TextDrawBackgroundColour(SpawnChoiseDraw[5], 51);
    TextDrawFont(SpawnChoiseDraw[5], TEXT_DRAW_FONT:1);
    TextDrawSetProportional(SpawnChoiseDraw[5], true);
    ...
    TextDrawAlignment(SpawnChoiseDraw[6], TEXT_DRAW_ALIGN:1);
    TextDrawColour(SpawnChoiseDraw[6], 421075440);
    TextDrawSetShadow(SpawnChoiseDraw[6], 0);
    TextDrawSetOutline(SpawnChoiseDraw[6], 0);
    TextDrawFont(SpawnChoiseDraw[6], TEXT_DRAW_FONT:4);
    ...
    TextDrawBackgroundColour(SpawnChoiseDraw[7], 0);
    TextDrawLetterSize(SpawnChoiseDraw[7], 1.1, 1.1);
    TextDrawTextSize(SpawnChoiseDraw[7], 43.000000, 48.0);
    TextDrawAlignment(SpawnChoiseDraw[7], TEXT_DRAW_ALIGN:1);
    TextDrawColour(SpawnChoiseDraw[7], -1);
    TextDrawUseBox(SpawnChoiseDraw[7], true);
    TextDrawBoxColour(SpawnChoiseDraw[7], 0);
    TextDrawSetShadow(SpawnChoiseDraw[7], 0);
    TextDrawSetOutline(SpawnChoiseDraw[7], 0);
    TextDrawFont(SpawnChoiseDraw[7], TEXT_DRAW_FONT:5);
    ...
    TextDrawAlignment(SpawnChoiseDraw[8], TEXT_DRAW_ALIGN:2);
    TextDrawColour(SpawnChoiseDraw[8], -1061109505);
    TextDrawSetShadow(SpawnChoiseDraw[8], 1);
    TextDrawSetOutline(SpawnChoiseDraw[8], 0);
    TextDrawBackgroundColour(SpawnChoiseDraw[8], 51);
    TextDrawFont(SpawnChoiseDraw[8], TEXT_DRAW_FONT:1);
    TextDrawSetProportional(SpawnChoiseDraw[8], true);
    ...
    TextDrawAlignment(SpawnChoiseDraw[9], TEXT_DRAW_ALIGN:1);
    TextDrawColour(SpawnChoiseDraw[9], 421075440);
    TextDrawSetShadow(SpawnChoiseDraw[9], 0);
    TextDrawSetOutline(SpawnChoiseDraw[9], 0);
    TextDrawFont(SpawnChoiseDraw[9], TEXT_DRAW_FONT:4);
    ...
    TextDrawBackgroundColour(SpawnChoiseDraw[10], 0);
    TextDrawLetterSize(SpawnChoiseDraw[10], 1.0, 1.0);
    TextDrawTextSize(SpawnChoiseDraw[10], 43.000000, 48.0);
    TextDrawAlignment(SpawnChoiseDraw[10], TEXT_DRAW_ALIGN:1);
    TextDrawColour(SpawnChoiseDraw[10], -1);
    TextDrawUseBox(SpawnChoiseDraw[10], true);
    TextDrawBoxColour(SpawnChoiseDraw[10], 0);
    TextDrawSetShadow(SpawnChoiseDraw[10], 0);
    TextDrawSetOutline(SpawnChoiseDraw[10], 0);
    TextDrawFont(SpawnChoiseDraw[10], TEXT_DRAW_FONT:5);
    ...
    TextDrawAlignment(SpawnChoiseDraw[11], TEXT_DRAW_ALIGN:2);
    TextDrawColour(SpawnChoiseDraw[11], -1061109505);
    TextDrawSetShadow(SpawnChoiseDraw[11], 1);
    TextDrawSetOutline(SpawnChoiseDraw[11], 0);
    TextDrawBackgroundColour(SpawnChoiseDraw[11], 51);
    TextDrawFont(SpawnChoiseDraw[11], TEXT_DRAW_FONT:1);
    TextDrawSetProportional(SpawnChoiseDraw[11], true);
    ...
    TextDrawAlignment(SpawnChoiseDraw[12], TEXT_DRAW_ALIGN:2);
    TextDrawColour(SpawnChoiseDraw[12], -1);
    TextDrawSetShadow(SpawnChoiseDraw[12], 1);
    TextDrawSetOutline(SpawnChoiseDraw[12], 0);
    TextDrawBackgroundColour(SpawnChoiseDraw[12], 51);
    TextDrawFont(SpawnChoiseDraw[12], TEXT_DRAW_FONT:1);
    TextDrawSetProportional(SpawnChoiseDraw[12], true);
    return 1;
}
