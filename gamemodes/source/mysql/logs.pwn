...
stock TradeLog(trade_id, p, t)
{
    ...
    mysql_format(pearsq_2, query, sizeof(query), 
        "INSERT INTO `trade_logs` ( \
            ...
            `slot_3_id`, \
            `slot_3_amount` \
        ) VALUES ('%d', '%d', '%e', '%e', '%d', '%e', '%e', '%e', '%d', '%d', '%e', '%d', '%d', '%e', '%d', '%d')",
